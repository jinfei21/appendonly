...
public class QuickCachePutGetPerfTest {
    private static final int INIT_COUNT = 200000;
    private static final String TEST_DIR = TestUtil.TEST_BASE_DIR + "performance/putget/";
    ...
    public void testSingleThreadPut() throws Exception {
        ...
        for (int i = 0; i < 2 * INIT_COUNT; i++) {
            ...
            String keyTwo = String.valueOf(random.nextInt(INIT_COUNT));
            byte[] result = cache.get(keyTwo);
